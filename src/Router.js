...
(function() {
  var ConfigContext, DownloadContext, EnterContext, ExecHandler, LOG, ObjectId, Router, SysConfigContext, TaskContext, UserAuthContext, UserContext, bodyParser, cookieParser, express, multer, session;
  ...
  Router = class Router {
    ...
    router() {
      var configRouter, storage, sysConfigRouter, taskRouter, upload, userAuthRouter, userRouter;
      ...
      new UserAuthContext().accessControl(function(err, auths) {
        auths = auths || [];
