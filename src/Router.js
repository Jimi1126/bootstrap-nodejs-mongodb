...
(function() {
  var ConfigContext, EnterContext, ExecHandler, LOG, ObjectId, Router, UserContext, bodyParser, cookieParser, express, multer, session;
  ...
  Router = class Router {
    ...
    router() {
      var configRouter, storage, upload, userRouter;
